				...
				<div class="wrapper">
					<div class="user_nav_wrapper">
						<div class="list_nav">
							...
							<div class="item_nav" data-toggle="tooltip" title="Hệ Điều Hành">
								<a href="/system" class="link_nav">
									<i class="fas fa-microchip"></i>
								</a>
							</div>
							<div class="item_nav" data-toggle="tooltip" title="Nhà Cung Cấp">
								<a href="/supplier" class="link_nav">
							...
							<div class="item_nav">
								<a href="/gallery" class="link_nav" title="Thư Viện Ảnh">
